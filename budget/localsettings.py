...
OPENID_SREG = {"required": "nickname, email, fullname", # originally this was 'requred' Should it be misspelled?
...
TWITTER_ACCESS_TOKEN = 'abc' # Must be defined to not cause error in backend
TWITTER_ACCESS_TOKEN_SECRET = 'abc' # Must be defined to not cause error in backend
